...
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text(
       f"𝐇𝐞𝐥𝐥𝐨 ❤️\n\n◆〓◆ ❖ 〖ᴷⁱⁿᴳ Ⱥʂʂìցղҽɾ♡▪︎•Å𝑁𝐈𐌑À𝐿•▪︎♡ ❖ ™ ◆〓◆\n\n❈ I Am A Bot For Download Links From Your **.TXT** File And Then Upload That File Om Telegram So Basically If You Want To Use Me First Send Me ⟰ /ASSIGNER Command And Then Follow Few Steps..", reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("✜ 𝐉𝐨𝐢𝐧 𝐔𝐩𝐃𝐚𝐭𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ✜" ,url=f"https://t.me/+Lf1-_QZfwktiZGU9") ],
                    [
                    InlineKeyboardButton("✜ Contact ✜" ,url="https://t.me/Assigner_baba") ],
                    [
                    InlineKeyboardButton("🦋 𝐅𝐨𝐥𝐥𝐨𝐰 𝐌𝐞 🦋" ,url="https://t.me/Dreamcivilservicess") ]                               
            ]))
...
@bot.on_message(filters.command(["ASSIGNER"]))
async def account_login(bot: Client, m: Message):
